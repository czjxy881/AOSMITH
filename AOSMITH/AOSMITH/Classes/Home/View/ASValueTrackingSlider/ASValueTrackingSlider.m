...
-(void)customeSliderView
{
    ...
    self.textColor = [UIColor whiteColor];
    self.popUpViewColor = [UIColor clearColor];
    ...
    [self setMinimumTrackImage:[UIImage imageNamed:@"T_setting"] forState:UIControlStateNormal];
    [self setMaximumTrackImage:[UIImage imageNamed:@"T_setting_bottom"] forState:UIControlStateNormal];
    [self showPopUpView];
}
